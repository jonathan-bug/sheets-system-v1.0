        ...
        <div class='row g-4 mb-4'>
            ...
            @else
                <h5 class='d-flex justify-content-end text-secondary mt-2 mb-4'>
                    Mes Actual: {{session('month')->month}}/{{session('month')->year}}
                </h5>
            @endif

            @if($v_emp_afp != null)
                <div class="col-sm-12 col-md-6">
                    <div class="p-4 card shadow" style="width: 100%">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-sm-6">
                            <div class="p-4 card shadow">
                                ...
                                <hr/>
                                <h2 class="card-title text-center">${{number_format($v_salary_total, 2)}}</h2>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="p-4 card shadow">
                                ...
                                <hr/>
                                <h2 class="card-title text-center">{{number_format($v_extra_day_hour, 2)}}</h2>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="p-4 card shadow">
                                ...
                                <hr/>
                                <h2 class="card-title text-center">{{number_format($v_extra_night_hour, 2)}}</h2>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="p-4 card shadow">
                                ...
                                <hr/>
                                <h2 class="card-title text-center">{{number_format($v_night_hour, 2)}}</h2>
                            </div>
                        </div>
                    </div>
                </div>
